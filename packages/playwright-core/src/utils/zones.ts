// !IMPORTANT!: This file is a copy of: https://github.com/microsoft/playwright/blob/v1.44.1/packages/playwright-core/src/utils/zones.ts
// When syncing upstream changes, make sure to drop these changes and use the original file.
...
export type ZoneType = 'apiZone' | 'expectZone' | 'stepZone' | 'launchZone';
...
class ZoneManager {
  ...
  zoneData<T>(type: ZoneType, stack: any): T | undefined {
