...
export class Screenshotter {
  ...
  async _preparePageForScreenshot(progress: Progress, frame: Frame, screenshotStyle: string | undefined, hideCaret: boolean, disableAnimations: boolean) {
    ...
    const inPagePrepareForScreenshotsSource = `((__name => (${inPagePrepareForScreenshots.toString()}))(t => t))`;
    await this._page.safeNonStallingEvaluateInAllFrames('(' + inPagePrepareForScreenshotsSource + `)(${JSON.stringify(screenshotStyle)}, ${hideCaret}, ${disableAnimations}, ${syncAnimations})`, 'utility');
