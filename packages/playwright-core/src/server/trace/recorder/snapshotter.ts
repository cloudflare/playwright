...
export class Snapshotter {
  ...
  async _initialize() {
    ...
    let frameSnapshotStreamerScript = `((__name => (${frameSnapshotStreamer}))(t => t))`;
    const initScriptSource = `(${frameSnapshotStreamerScript})("${this._snapshotStreamer}", ${javaScriptEnabled || javaScriptEnabled === undefined})`;
